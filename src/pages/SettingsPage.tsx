  ...
  const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (result.errors.length > 0) {
        setMessage({
          type: result.itemsImported > 0 || result.outfitsImported > 0 ? 'info' : 'error',
          text: `Imported ${result.itemsImported} items and ${
            result.outfitsImported
          } outfits, but ${result.errors.length} item(s) failed. Check console for details.${
            ...
            <div className={styles.cardContent}>
              <div className={styles.infoBox}>
                <Callout.Root size="1" color="blue">
                  ...
                  <Callout.Text>
                    Enable AI-powered wear logging by generating embeddings for your wardrobe items.
                    This is a one-time setup that allows the app to automatically recognize items in
                    outfit photos.
                  </Callout.Text>
                </Callout.Root>
              </div>
                ...
                <div className={styles.infoBox}>
                  <Callout.Root color="amber">
                    <Callout.Text>
                      ...
                      {itemsNeedingEmbeddings.length === 1 ? 'item' : 'items'} need embeddings for
                      AI wear logging. Click below to generate them.
                    </Callout.Text>
                  </Callout.Root>
                </div>
              )}
              ...
              {!hasEmbeddingGap && items.length > 0 && (
                <div className={styles.infoBox}>
                  <Callout.Root color="green">
                    <Callout.Text>
                      ✅ All {items.length} {items.length === 1 ? 'item has' : 'items have'}{' '}
              ...
              <div className={styles.helpText}>
                <Text size="2" color="gray">
                  <strong>What are embeddings?</strong> AI "fingerprints" of your items that enable
                  photo-based wear logging. Uses FashionCLIP for fashion-specific recognition.
                </Text>
                <Text size="2" color="gray">
                  <strong>When to generate:</strong> For new items that don't have embeddings yet.
                </Text>
                <Text size="2" color="gray">
                  <strong>When to regenerate all:</strong> After updating to a new AI model, or if
                  you've imported items with old embeddings.
                </Text>
                <Text size="2" color="gray">
                  <strong>How matching works:</strong> Uses cosine similarity to compare outfit
                  photos with item embeddings. Higher similarity = better match.
                </Text>
              </div>
            ...
            <div className={styles.cardContent}>
              <div className={styles.infoBox}>
                <Callout.Root size="1" color="purple">
                  ...
                  <Callout.Text>
                    The AI learns from your accept/reject feedback to improve matching accuracy over
                    time. The more you use it, the better it gets!
                  </Callout.Text>
                </Callout.Root>
              </div>
                ...
                <>
                  ...
                  {feedbackStats.totalFeedback >= 5 && (
                    <div className={styles.infoBox}>
                      <Callout.Root color="green">
                        <Callout.Text>
                          ✅ Enough feedback collected! The AI can now learn from your preferences.
                          Click "Update AI Learning" to apply.
                        </Callout.Text>
                      </Callout.Root>
                    </div>
                  )}
                  ...
                  {feedbackStats.totalFeedback < 5 && (
                    <div className={styles.infoBox}>
                      <Callout.Root color="amber">
                        <Callout.Text>
                          ⏳ Keep providing feedback! Need {5 - feedbackStats.totalFeedback} more to
                          start learning.
                        </Callout.Text>
                      </Callout.Root>
                    </div>
              ...
              {(!feedbackStats || feedbackStats.totalFeedback === 0) && (
                <div className={styles.infoBox}>
                  <Callout.Root color="blue">
                    <Callout.Text>
                      No feedback yet. Use the accept ✓ and reject ✗ buttons in the AI Wear Logging
                      page to start teaching the AI your preferences.
                    </Callout.Text>
                  </Callout.Root>
                </div>
              )}
              ...
              <div className={styles.buttonGroup}>
                <Button
                  ...
                  disabled={
                    isUpdatingPreferences || !feedbackStats || feedbackStats.totalFeedback < 5
                  }
                  className={styles.primaryButton}
                >
                ...
                <Button
                  ...
                  disabled={
                    isResettingLearning || !feedbackStats || feedbackStats.totalFeedback === 0
                  }
                  className={styles.secondaryButton}
                >
              ...
              <div className={styles.helpText}>
                <Text size="2" color="gray">
                  <strong>How it works:</strong> The AI analyzes your accept/reject patterns to
                  understand which items you prefer (favorites, new items, specific brands, etc.)
                </Text>
                <Text size="2" color="gray">
                  <strong>When to update:</strong> After providing feedback on 10-20 outfit photos
                  for best results.
                </Text>
                <Text size="2" color="gray">
            ...
            <div className={styles.cardContent}>
              <div className={styles.infoBox}>
                <Callout.Root size="1" color="orange">
                  ...
                  <Callout.Text>
                    If you're experiencing issues like items disappearing or appearing in the wrong
                    places, this repair tool can fix data inconsistencies.
                  </Callout.Text>
                </Callout.Root>
              </div>
              ...
              <div className={styles.helpText}>
                <Text size="2" color="gray">
                  <strong>Repair:</strong> Fixes invalid categories, wear counts, and missing
                  fields.
                </Text>
                <Text size="2" color="gray">
                  <strong>Diagnostic:</strong> Shows detailed info in browser console (for
                  debugging).
                </Text>
              </div>
            </div>
